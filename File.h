...
#include <cstdarg>
#include "Lib.h" // For idSwap, ID_TIME_T
#include "Str.h"
#include "math/Vector.h" // For idVec2, idVec3, idVec4, idVec6
#include "math/Matrix.h" // For idMat3
...
// Stub verify format string macro if not present
