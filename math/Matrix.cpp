...
bool idMatX::Inverse_GaussJordan( void ) {
	...
	int *columnIndex = (int *) alloca( numRows * sizeof( int ) );
	int *rowIndex = (int *) alloca( numRows * sizeof( int ) );
	bool *pivot = (bool *) alloca( numRows * sizeof( bool ) );
...
bool idMatX::LU_UpdateRankOne( const idVecX &v, const idVecX &w, float alpha, int *index ) {
	...
	y = (float *) alloca( v.GetSize() * sizeof( float ) );
	z = (float *) alloca( w.GetSize() * sizeof( float ) );
...
bool idMatX::LU_UpdateRowColumn( const idVecX &v, const idVecX &w, int r, int *index ) {
	...
	y0 = (float *) alloca( v.GetSize() * sizeof( float ) );
	z0 = (float *) alloca( w.GetSize() * sizeof( float ) );
	y1 = (float *) alloca( v.GetSize() * sizeof( float ) );
	z1 = (float *) alloca( w.GetSize() * sizeof( float ) );
...
bool idMatX::Cholesky_Factor( void ) {
	...
	invSqrt = (float *) alloca( numRows * sizeof( float ) );
...
bool idMatX::Cholesky_UpdateRowColumn( const idVecX &v, int r ) {
	...
	addSub.SetData( numColumns, (float *) alloca( numColumns * sizeof( float ) ) );
	...
	if ( r == 0 ) {
		...
		original = (float *) alloca( numColumns * sizeof( float ) );
	...
	v1.SetData( numColumns, (float *) alloca( numColumns * sizeof( float ) ) );
	v2.SetData( numColumns, (float *) alloca( numColumns * sizeof( float ) ) );
	...
	v1 = (float *) alloca( numColumns * sizeof( float ) );
	v2 = (float *) alloca( numColumns * sizeof( float ) );
...
bool idMatX::Cholesky_UpdateIncrement( const idVecX &v ) {
	...
	x = (float *) alloca( numRows * sizeof( float ) );
...
bool idMatX::LDLT_Factor( void ) {
	...
	v = (float *) alloca( numRows * sizeof( float ) );
...
bool idMatX::LDLT_UpdateRowColumn( const idVecX &v, int r ) {
	...
	original = (float *) alloca( numColumns * sizeof( float ) );
		y = (float *) alloca( numColumns * sizeof( float ) );
...
float idMatX::DeterminantGeneric( void ) const {
	...
	index = (int *) alloca( numRows * sizeof( int ) );
