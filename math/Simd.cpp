...
*/
void SIMD_Init( void ) {
	generic = new idSIMDProcessor_Generic;
	generic->cpuid = CPUID_NONE;
	processor = NULL;
...
============
*/
void SIMD_InitProcessor( const char *module, bool forceGeneric ) {
	SIMDProcessor = generic;
}
...
idSIMDProcessorProcessor *p_simd;
idSIMDProcessorProcessor *p_generic;
int baseClocks = 0;
...
/*
============
idSIMDProcessor::Test_f
============
*/
void idSIMDProcessor::Test_f( const idCmdArgs &args ) {
