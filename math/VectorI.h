...
public:
	...
	idVec4i( void );
	explicit idVec4i( const int x ) { Set( x, x, x, x ); }
	explicit idVec4i( const int x, const int y, const int z, const int w );
	...
	int			operator*( const idVec4i &a ) const;
	idVec4i			operator*( const int a ) const;
	idVec4i			operator/( const int a ) const;
	...
	idVec4i &operator-=( const idVec4i &a );
	idVec4i &operator/=( const idVec4i &a );
	idVec4i &operator/=( const int a );
	idVec4i &operator*=( const int a );

	friend idVec4i	operator*( const int a, const idVec4i b );
...
ID_INLINE idVec4i::idVec4i( const int x, const int y, const int z, const int w ) {
	this->x = x;
	this->y = y;
	this->z = z;
	this->w = w;
...
ID_INLINE void idVec4i::Set( const int x, const int y, const int z, const int w ) {
	this->x = x;
	this->y = y;
	this->z = z;
	this->w = w;
...
ID_INLINE int &idVec4i::operator[]( int index ) {
	return ( &x )[index];
}
...
ID_INLINE int idVec4i::operator*( const idVec4i &a ) const {
	return x * a.x + y * a.y + z * a.z + w * a.w;
}

ID_INLINE idVec4i idVec4i::operator*( const int a ) const {
...
ID_INLINE idVec4i &idVec4i::operator/=( const int a ) {
	x /= a;
	y /= a;
	z /= a;
	w /= a;
...
ID_INLINE const int *idVec4i::ToIntPtr( void ) const {
	return &x;
}

ID_INLINE int *idVec4i::ToIntPtr( void ) {
	return &x;
}
