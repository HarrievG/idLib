...
/*
============
idSIMDProcessor_Generic::GetName
============
*/
const char * idSIMDProcessor_Generic::GetName( void ) const {
	return "generic code";
}

/*
============
idSIMDProcessor_Generic::Add

  dst[i] = constant + src[i];
============
*/
void VPCALL idSIMDProcessor_Generic::Add( float *dst, const float constant, const float *src, const int count ) {
...
============
*/
void VPCALL idSIMDProcessor_Generic::Add( float *dst, const float *src0, const float *src1, const int count ) {
...
/*
============
idSIMDProcessor_Generic::Sub

  dst[i] = constant - src[i];
============
*/
void VPCALL idSIMDProcessor_Generic::Sub( float *dst, const float constant, const float *src, const int count ) {
	double c = constant;
...
============
*/
void VPCALL idSIMDProcessor_Generic::Sub( float *dst, const float *src0, const float *src1, const int count ) {
#define OPER(X) dst[(X)] = src0[(X)] - src1[(X)];
	UNROLL4(OPER)
#undef OPER
}
...
/*
============
idSIMDProcessor_Generic::Mul

  dst[i] = constant * src[i];
============
*/
void VPCALL idSIMDProcessor_Generic::Mul( float *dst, const float constant, const float *src0, const int count) {
	double c = constant;
...
============
*/
void VPCALL idSIMDProcessor_Generic::Mul( float *dst, const float *src0, const float *src1, const int count ) {
#define OPER(X) (dst[(X)] = src0[(X)] * src1[(X)])
	UNROLL4(OPER)
#undef OPER
}
...
/*
============
idSIMDProcessor_Generic::Div

  dst[i] = constant / divisor[i];
============
*/
void VPCALL idSIMDProcessor_Generic::Div( float *dst, const float constant, const float *divisor, const int count ) {
	double c = constant;
...
============
*/
void VPCALL idSIMDProcessor_Generic::Div( float *dst, const float *src0, const float *src1, const int count ) {
#define OPER(X) (dst[(X)] = src0[(X)] / src1[(X)])
	UNROLL4(OPER)
#undef OPER
}
...
/*
============
idSIMDProcessor_Generic::MulAdd

  dst[i] += constant * src[i];
============
*/
void VPCALL idSIMDProcessor_Generic::MulAdd( float *dst, const float constant, const float *src, const int count ) {
	double c = constant;
#define OPER(X) (dst[(X)] += c * src[(X)])
	UNROLL4(OPER)
#undef OPER
...
============
*/
void VPCALL idSIMDProcessor_Generic::MulAdd( float *dst, const float *src0, const float *src1, const int count ) {
#define OPER(X) (dst[(X)] += src0[(X)] * src1[(X)])
	UNROLL4(OPER)
#undef OPER
}
...
/*
============
idSIMDProcessor_Generic::MulSub

  dst[i] -= constant * src[i];
============
*/
void VPCALL idSIMDProcessor_Generic::MulSub( float *dst, const float constant, const float *src, const int count ) {
	double c = constant;
#define OPER(X) (dst[(X)] -= c * src[(X)])
	UNROLL4(OPER)
#undef OPER
...
============
*/
void VPCALL idSIMDProcessor_Generic::MulSub( float *dst, const float *src0, const float *src1, const int count ) {
#define OPER(X) (dst[(X)] -= src0[(X)] * src1[(X)])
	UNROLL4(OPER)
#undef OPER
}
...
/*
============
idSIMDProcessor_Generic::Dot

  dst[i] = constant * src[i];
============
*/
void VPCALL idSIMDProcessor_Generic::Dot( float *dst, const idVec3 &constant, const idVec3 *src, const int count ) {
...
============
*/
void VPCALL idSIMDProcessor_Generic::Dot( float *dst, const idVec3 &constant, const idPlane *src, const int count ) {
...
============
*/
void VPCALL idSIMDProcessor_Generic::Dot( float *dst, const idVec3 &constant, const idDrawVert *src, const int count ) {
...
============
*/
void VPCALL idSIMDProcessor_Generic::Dot( float *dst, const idPlane &constant, const idVec3 *src, const int count ) {
...
============
*/
void VPCALL idSIMDProcessor_Generic::Dot( float *dst, const idPlane &constant, const idPlane *src, const int count ) {
...
============
*/
void VPCALL idSIMDProcessor_Generic::Dot( float *dst, const idPlane &constant, const idDrawVert *src, const int count ) {
...
============
*/
void VPCALL idSIMDProcessor_Generic::Dot( float *dst, const idVec3 *src0, const idVec3 *src1, const int count ) {
#define OPER(X) dst[(X)] = src0[(X)] * src1[(X)];
	UNROLL1(OPER)
#undef OPER
}
...
============
*/
void VPCALL idSIMDProcessor_Generic::Dot( float &dot, const float *src1, const float *src2, const int count ) {
#if 1
...
/*
============
idSIMDProcessor_Generic::CmpGT

  dst[i] = src0[i] > constant;
============
*/
void VPCALL idSIMDProcessor_Generic::CmpGT( byte *dst, const float *src0, const float constant, const int count ) {
...
============
*/
void VPCALL idSIMDProcessor_Generic::CmpGT( byte *dst, const byte bitNum, const float *src0, const float constant, const int count ) {
...
/*
============
idSIMDProcessor_Generic::CmpGE

  dst[i] = src0[i] >= constant;
============
*/
void VPCALL idSIMDProcessor_Generic::CmpGE( byte *dst, const float *src0, const float constant, const int count ) {
#define OPER(X) dst[(X)] = src0[(X)] >= constant;
	UNROLL4(OPER)
#undef OPER
}
...
============
*/
void VPCALL idSIMDProcessor_Generic::CmpGE( byte *dst, const byte bitNum, const float *src0, const float constant, const int count ) {
#define OPER(X) dst[(X)] |= ( src0[(X)] >= constant ) << bitNum;
	UNROLL4(OPER)
#undef OPER
}
...
/*
============
idSIMDProcessor_Generic::CmpLT

  dst[i] = src0[i] < constant;
============
*/
void VPCALL idSIMDProcessor_Generic::CmpLT( byte *dst, const float *src0, const float constant, const int count ) {
#define OPER(X) dst[(X)] = src0[(X)] < constant;
	UNROLL4(OPER)
#undef OPER
}
...
============
*/
void VPCALL idSIMDProcessor_Generic::CmpLT( byte *dst, const byte bitNum, const float *src0, const float constant, const int count ) {
#define OPER(X) dst[(X)] |= ( src0[(X)] < constant ) << bitNum;
	UNROLL4(OPER)
#undef OPER
}
...
/*
============
idSIMDProcessor_Generic::CmpLE

  dst[i] = src0[i] <= constant;
============
*/
void VPCALL idSIMDProcessor_Generic::CmpLE( byte *dst, const float *src0, const float constant, const int count ) {
#define OPER(X) dst[(X)] = src0[(X)] <= constant;
	UNROLL4(OPER)
#undef OPER
}
...
============
*/
void VPCALL idSIMDProcessor_Generic::CmpLE( byte *dst, const byte bitNum, const float *src0, const float constant, const int count ) {
#define OPER(X) dst[(X)] |= ( src0[(X)] <= constant ) << bitNum;
	UNROLL4(OPER)
#undef OPER
}
...
/*
============
idSIMDProcessor_Generic::MinMax
============
*/
void VPCALL idSIMDProcessor_Generic::MinMax( float &min, float &max, const float *src, const int count ) {
...
============
*/
void VPCALL idSIMDProcessor_Generic::MinMax( idVec2 &min, idVec2 &max, const idVec2 *src, const int count ) {
...
============
*/
void VPCALL idSIMDProcessor_Generic::MinMax( idVec3 &min, idVec3 &max, const idVec3 *src, const int count ) {
...
============
*/
void VPCALL idSIMDProcessor_Generic::MinMax( idVec3 &min, idVec3 &max, const idDrawVert *src, const int count ) {
	min[0] = min[1] = min[2] = idMath::INFINITY; max[0] = max[1] = max[2] = -idMath::INFINITY;
...
============
*/
void VPCALL idSIMDProcessor_Generic::MinMax( idVec3 &min, idVec3 &max, const idDrawVert *src, const int *indexes, const int count ) {
	min[0] = min[1] = min[2] = idMath::INFINITY; max[0] = max[1] = max[2] = -idMath::INFINITY;
...
/*
============
idSIMDProcessor_Generic::Clamp
============
*/
void VPCALL idSIMDProcessor_Generic::Clamp( float *dst, const float *src, const float min, const float max, const int count ) {
...
/*
============
idSIMDProcessor_Generic::ClampMin
============
*/
void VPCALL idSIMDProcessor_Generic::ClampMin( float *dst, const float *src, const float min, const int count ) {
...
/*
============
idSIMDProcessor_Generic::ClampMax
============
*/
void VPCALL idSIMDProcessor_Generic::ClampMax( float *dst, const float *src, const float max, const int count ) {
...
/*
================
idSIMDProcessor_Generic::Memcpy
================
*/
void VPCALL idSIMDProcessor_Generic::Memcpy( void *dst, const void *src, const int count ) {
	memcpy( dst, src, count );
}

/*
================
idSIMDProcessor_Generic::Memset
================
*/
void VPCALL idSIMDProcessor_Generic::Memset( void *dst, const int val, const int count ) {
	memset( dst, val, count );
}

/*
============
idSIMDProcessor_Generic::Zero16
============
*/
void VPCALL idSIMDProcessor_Generic::Zero16( float *dst, const int count ) {
	memset( dst, 0, count * sizeof( float ) );
}

/*
============
idSIMDProcessor_Generic::Negate16
============
*/
void VPCALL idSIMDProcessor_Generic::Negate16( float *dst, const int count ) {
...
/*
============
idSIMDProcessor_Generic::Copy16
============
*/
void VPCALL idSIMDProcessor_Generic::Copy16( float *dst, const float *src, const int count ) {
...
/*
============
idSIMDProcessor_Generic::Add16
============
*/
void VPCALL idSIMDProcessor_Generic::Add16( float *dst, const float *src1, const float *src2, const int count ) {
...
/*
============
idSIMDProcessor_Generic::Sub16
============
*/
void VPCALL idSIMDProcessor_Generic::Sub16( float *dst, const float *src1, const float *src2, const int count ) {
#define OPER(X) dst[(X)] = src1[(X)] - src2[(X)]
	UNROLL1(OPER)
#undef OPER
}
...
/*
============
idSIMDProcessor_Generic::Mul16
============
*/
void VPCALL idSIMDProcessor_Generic::Mul16( float *dst, const float *src1, const float constant, const int count ) {
...
/*
============
idSIMDProcessor_Generic::AddAssign16
============
*/
void VPCALL idSIMDProcessor_Generic::AddAssign16( float *dst, const float *src, const int count ) {
#define OPER(X) dst[(X)] += src[(X)]
	UNROLL1(OPER)
#undef OPER
}
...
/*
============
idSIMDProcessor_Generic::SubAssign16
============
*/
void VPCALL idSIMDProcessor_Generic::SubAssign16( float *dst, const float *src, const int count ) {
#define OPER(X) dst[(X)] -= src[(X)]
	UNROLL1(OPER)
#undef OPER
}
...
/*
============
idSIMDProcessor_Generic::MulAssign16
============
*/
void VPCALL idSIMDProcessor_Generic::MulAssign16( float *dst, const float constant, const int count ) {
...
/*
============
idSIMDProcessor_Generic::MatX_MultiplyVecX
============
*/
void VPCALL idSIMDProcessor_Generic::MatX_MultiplyVecX( idVecX &dst, const idMatX &mat, const idVecX &vec ) {
	int i, j, numRows;
...
/*
============
idSIMDProcessor_Generic::MatX_MultiplyAddVecX
============
*/
void VPCALL idSIMDProcessor_Generic::MatX_MultiplyAddVecX( idVecX &dst, const idMatX &mat, const idVecX &vec ) {
	int i, j, numRows;
	const float *mPtr, *vPtr;
	float *dstPtr;
...
/*
============
idSIMDProcessor_Generic::MatX_MultiplySubVecX
============
*/
void VPCALL idSIMDProcessor_Generic::MatX_MultiplySubVecX( idVecX &dst, const idMatX &mat, const idVecX &vec ) {
	int i, j, numRows;
	const float *mPtr, *vPtr;
	float *dstPtr;
...
/*
============
idSIMDProcessor_Generic::MatX_TransposeMultiplyVecX
============
*/
void VPCALL idSIMDProcessor_Generic::MatX_TransposeMultiplyVecX( idVecX &dst, const idMatX &mat, const idVecX &vec ) {
	int i, j, numColumns;
	const float *mPtr, *vPtr;
	float *dstPtr;
...
/*
============
idSIMDProcessor_Generic::MatX_TransposeMultiplyAddVecX
============
*/
void VPCALL idSIMDProcessor_Generic::MatX_TransposeMultiplyAddVecX( idVecX &dst, const idMatX &mat, const idVecX &vec ) {
	int i, j, numColumns;
	const float *mPtr, *vPtr;
	float *dstPtr;
...
/*
============
idSIMDProcessor_Generic::MatX_TransposeMultiplySubVecX
============
*/
void VPCALL idSIMDProcessor_Generic::MatX_TransposeMultiplySubVecX( idVecX &dst, const idMatX &mat, const idVecX &vec ) {
	int i, numColumns;
	const float *mPtr, *vPtr;
	float *dstPtr;
...
/*
============
idSIMDProcessor_Generic::MatX_MultiplyMatX
...
============
*/
void VPCALL idSIMDProcessor_Generic::MatX_MultiplyMatX( idMatX &dst, const idMatX &m1, const idMatX &m2 ) {
	int i, j, k, l, n;
	float *dstPtr;
...
/*
============
idSIMDProcessor_Generic::MatX_TransposeMultiplyMatX
...
============
*/
void VPCALL idSIMDProcessor_Generic::MatX_TransposeMultiplyMatX( idMatX &dst, const idMatX &m1, const idMatX &m2 ) {
	int i, j, k, l, n;
	float *dstPtr;
	const float *m1Ptr, *m2Ptr;
	double sum;
...
/*
============
idSIMDProcessor_Generic::MatX_LowerTriangularSolve
...
============
*/
void VPCALL idSIMDProcessor_Generic::MatX_LowerTriangularSolve( const idMatX &L, float *x, const float *b, const int n, int skip ) {
#if 1
...
/*
============
idSIMDProcessor_Generic::MatX_LowerTriangularSolveTranspose
...
============
*/
void VPCALL idSIMDProcessor_Generic::MatX_LowerTriangularSolveTranspose( const idMatX &L, float *x, const float *b, const int n ) {
#if 1
...
/*
============
idSIMDProcessor_Generic::MatX_LDLTFactor

  in-place factorization LDL' of the n * n sub-matrix of mat
  the reciprocal of the diagonal elements are stored in invDiag
============
*/
bool VPCALL idSIMDProcessor_Generic::MatX_LDLTFactor( idMatX &mat, idVecX &invDiag, const int n ) {
#if 1
	...
	v = (float *) alloca( n * sizeof( float ) );
	diag = (float *) alloca( n * sizeof( float ) );
...
/*
============
idSIMDProcessor_Generic::BlendJoints
============
*/
void VPCALL idSIMDProcessor_Generic::BlendJoints( idJointQuat *joints, const idJointQuat *blendJoints, const float lerp, const int *index, const int numJoints ) {
	int i;
...
/*
============
idSIMDProcessor_Generic::ConvertJointQuatsToJointMats
============
*/
void VPCALL idSIMDProcessor_Generic::ConvertJointQuatsToJointMats( idJointMat *jointMats, const idJointQuat *jointQuats, const int numJoints ) {
	int i;
...
/*
============
idSIMDProcessor_Generic::ConvertJointMatsToJointQuats
============
*/
void VPCALL idSIMDProcessor_Generic::ConvertJointMatsToJointQuats( idJointQuat *jointQuats, const idJointMat *jointMats, const int numJoints ) {
	int i;
...
/*
============
idSIMDProcessor_Generic::TransformJoints
============
*/
void VPCALL idSIMDProcessor_Generic::TransformJoints( idJointMat *jointMats, const int *parents, const int firstJoint, const int lastJoint ) {
	int i;
...
/*
============
idSIMDProcessor_Generic::UntransformJoints
============
*/
void VPCALL idSIMDProcessor_Generic::UntransformJoints( idJointMat *jointMats, const int *parents, const int firstJoint, const int lastJoint ) {
	int i;
...
/*
============
idSIMDProcessor_Generic::TransformVerts
============
*/
void VPCALL idSIMDProcessor_Generic::TransformVerts( idDrawVert *verts, const int numVerts, const idJointMat *joints, const idVec4 *weights, const int *index, int numWeights ) {
	int i, j;
...
/*
============
idSIMDProcessor_Generic::TracePointCull
============
*/
void VPCALL idSIMDProcessor_Generic::TracePointCull( byte *cullBits, byte &totalOr, const float radius, const idPlane *planes, const idDrawVert *verts, const int numVerts ) {
	int i;
	byte tOr;
...
/*
============
idSIMDProcessor_Generic::DecalPointCull
============
*/
void VPCALL idSIMDProcessor_Generic::DecalPointCull( byte *cullBits, const idPlane *planes, const idDrawVert *verts, const int numVerts ) {
	int i;
...
/*
============
idSIMDProcessor_Generic::OverlayPointCull
============
*/
void VPCALL idSIMDProcessor_Generic::OverlayPointCull( byte *cullBits, idVec2 *texCoords, const idPlane *planes, const idDrawVert *verts, const int numVerts ) {
	int i;
...
/*
============
idSIMDProcessor_Generic::DeriveTriPlanes

	Derives a plane equation for each triangle.
============
*/
void VPCALL idSIMDProcessor_Generic::DeriveTriPlanes( idPlane *planes, const idDrawVert *verts, const int numVerts, const int *indexes, const int numIndexes ) {
	int i;
...
/*
============
idSIMDProcessor_Generic::DeriveTangents
...
============
*/
//void VPCALL idSIMDProcessor_Generic::DeriveTangents( idPlane *planes, idDrawVert *verts, const int numVerts, const int *indexes, const int numIndexes ) {
//	int i;
//
//	bool *used = (bool *)alloca( numVerts * sizeof( used[0] ) );
...
/*
============
idSIMDProcessor_Generic::DeriveUnsmoothedTangents
...
void VPCALL idSIMDProcessor_Generic::DeriveUnsmoothedTangents( idDrawVert *verts, const dominantTri_s *dominantTris, const int numVerts ) {
//	int i;
//
//	for ( i = 0; i < numVerts; i++ ) {
//		idDrawVert *a, *b, *c;
...
/*
============
idSIMDProcessor_Generic::NormalizeTangents
...
============
*/
void VPCALL idSIMDProcessor_Generic::NormalizeTangents( idDrawVert *verts, const int numVerts ) {
...
/*
============
idSIMDProcessor_Generic::CreateTextureSpaceLightVectors
...
============
*/
void VPCALL idSIMDProcessor_Generic::CreateTextureSpaceLightVectors( idVec3 *lightVectors, const idVec3 &lightOrigin, const idDrawVert *verts, const int numVerts, const int *indexes, const int numIndexes ) {
...
/*
============
idSIMDProcessor_Generic::CreateSpecularTextureCoords
...
============
*/
void VPCALL idSIMDProcessor_Generic::CreateSpecularTextureCoords( idVec4 *texCoords, const idVec3 &lightOrigin, const idVec3 &viewOrigin, const idDrawVert *verts, const int numVerts, const int *indexes, const int numIndexes ) {
...
/*
============
idSIMDProcessor_Generic::CreateShadowCache
============
*/
int VPCALL idSIMDProcessor_Generic::CreateShadowCache( idVec4 *vertexCache, int *vertRemap, const idVec3 &lightOrigin, const idDrawVert *verts, const int numVerts ) {
	int outVerts = 0;
...
/*
============
idSIMDProcessor_Generic::CreateVertexProgramShadowCache
============
*/
int VPCALL idSIMDProcessor_Generic::CreateVertexProgramShadowCache( idVec4 *vertexCache, const idDrawVert *verts, const int numVerts ) {
	for ( int i = 0; i < numVerts; i++ ) {
		const float *v = verts[i].xyz.ToFloatPtr();
...
/*
============
idSIMDProcessor_Generic::UpSamplePCMTo44kHz

  Duplicate samples for 44kHz output.
============
*/
void idSIMDProcessor_Generic::UpSamplePCMTo44kHz( float *dest, const short *src, const int numSamples, const int kHz, const int numChannels ) {
	if ( kHz == 11025 ) {
		if ( numChannels == 1 ) {
...
/*
============
idSIMDProcessor_Generic::UpSampleOGGTo44kHz

  Duplicate samples for 44kHz output.
============
*/
void idSIMDProcessor_Generic::UpSampleOGGTo44kHz( float *dest, const float * const *ogg, const int numSamples, const int kHz, const int numChannels ) {
	if ( kHz == 11025 ) {
		if ( numChannels == 1 ) {
			for ( int i = 0; i < numSamples; i++ ) {
...
/*
============
idSIMDProcessor_Generic::MixSoundTwoSpeakerMono
============
*/
void VPCALL idSIMDProcessor_Generic::MixSoundTwoSpeakerMono( float *mixBuffer, const float *samples, const int numSamples, const float lastV[2], const float currentV[2] ) {
	float sL = lastV[0];
	float sR = lastV[1];
...
/*
============
idSIMDProcessor_Generic::MixSoundTwoSpeakerStereo
============
*/
void VPCALL idSIMDProcessor_Generic::MixSoundTwoSpeakerStereo( float *mixBuffer, const float *samples, const int numSamples, const float lastV[2], const float currentV[2] ) {
	float sL = lastV[0];
	float sR = lastV[1];
	float incL = ( currentV[0] - lastV[0] ) / MIXBUFFER_SAMPLES;
	float incR = ( currentV[1] - lastV[1] ) / MIXBUFFER_SAMPLES;
...
/*
============
idSIMDProcessor_Generic::MixSoundSixSpeakerMono
============
*/
void VPCALL idSIMDProcessor_Generic::MixSoundSixSpeakerMono( float *mixBuffer, const float *samples, const int numSamples, const float lastV[6], const float currentV[6] ) {
	float sL0 = lastV[0];
	float sL1 = lastV[1];
	float sL2 = lastV[2];
	float sL3 = lastV[3];
...
/*
============
idSIMDProcessor_Generic::MixSoundSixSpeakerStereo
============
*/
void VPCALL idSIMDProcessor_Generic::MixSoundSixSpeakerStereo( float *mixBuffer, const float *samples, const int numSamples, const float lastV[6], const float currentV[6] ) {
	float sL0 = lastV[0];
	float sL1 = lastV[1];
	float sL2 = lastV[2];
	float sL3 = lastV[3];
...
/*
============
idSIMDProcessor_Generic::MixedSoundToSamples
============
*/
void VPCALL idSIMDProcessor_Generic::MixedSoundToSamples( short *samples, const float *mixBuffer, const int numSamples ) {
