...
===============================================================================
	...
	No stdio calls should be used by any part of the game.
...
// Simplified idResourceCacheEntry to allow compilation if needed, though we strip resource system mostly.
...
public:
    ...
    // OpenExplicitPakFile removed as we are not supporting zips for now.
    ...
    virtual bool		    IsFolder( const char* relativePath, const char* basePath = "fs_basepath" ) = 0;

	// resource tracking and related things (Stubbed or removed mostly)
